        ...
        try {
            ...
            if (msg.saveToSheet) {
                try {
                    ...
                    const response = yield fetch(`${GOOGLE_SCRIPT_URL}?number=${encodeURIComponent(numberText)}&fileName=${encodeURIComponent(fileName)}&userName=${encodeURIComponent(userName)}&date=${encodeURIComponent(currentDate)}`, {
                        method: 'GET'
                    });
